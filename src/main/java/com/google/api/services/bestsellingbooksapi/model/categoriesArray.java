...
/**
 * Model definition for Bestsellingbooksapi.categoriesArray.
 *
 ...
 * @author Google, Inc.
 */
public final class categoriesArray extends GenericJson {

  @Key
  java.util.List<CategoriesItem> items;
   ...
   * example, a request that returns a single categoriesArray would include the response headers,
   * while a request which returns an array of categoriesArray, would have a non-null response
