...
/**
 * Model definition for Bestsellingbooksapi.TitlesResponse.
 *
 ...
 * @author Google, Inc.
 */
public final class TitlesResponse extends GenericJson {
  ...
  public TitlesResponse setAPIParameters(ApiParameters aPIParameters) {
  ...
  public TitlesResponse setTitles(java.util.List<String> titles) {
    this.titles = titles;
    return this;
  }
   ...
   * example, a request that returns a single TitlesResponse would include the response headers,
   * while a request which returns an array of TitlesResponse, would have a non-null response header
