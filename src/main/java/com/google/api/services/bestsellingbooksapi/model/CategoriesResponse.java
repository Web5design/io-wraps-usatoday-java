...
/**
 * Model definition for Bestsellingbooksapi.CategoriesResponse.
 *
 ...
 * @author Google, Inc.
 */
public final class CategoriesResponse extends GenericJson {
  ...
  public CategoriesResponse setAPIParameters(ApiParameters aPIParameters) {
   ...
   */
  @Key("Categories")
  private java.util.List<CategoriesItem> categories;

  
  public java.util.List<CategoriesItem> getCategories() {
    return categories;
  }

  
  public CategoriesResponse setCategories(java.util.List<CategoriesItem> categories) {
   ...
   * example, a request that returns a single CategoriesResponse would include the response headers,
   * while a request which returns an array of CategoriesResponse, would have a non-null response
