...
/**
 * Model definition for Bestsellingbooksapi.bookListDatesArray.
 *
 ...
 * @author Google, Inc.
 */
public final class bookListDatesArray extends GenericJson {

  @Key
  java.util.List<BookListByDate> items;
   ...
   * example, a request that returns a single bookListDatesArray would include the response headers,
   * while a request which returns an array of bookListDatesArray, would have a non-null response
