...
/**
 * Model definition for Bestsellingbooksapi.rankHistoriesArray.
 *
 ...
 * @author Google, Inc.
 */
public final class rankHistoriesArray extends GenericJson {

  @Key
  java.util.List<RankHistoryEntry> items;
   ...
   * example, a request that returns a single rankHistoriesArray would include the response headers,
   * while a request which returns an array of rankHistoriesArray, would have a non-null response
