...
/**
 * Model definition for Bestsellingbooksapi.BookListByDate.
 *
 ...
 * @author Google, Inc.
 */
public final class BookListByDate extends GenericJson {
  ...
  public BookListByDate setDate(String date) {
    this.date = date;
    return this;
  }
  /**
   ...
   */
  @Key("BookListAPIUrl")
  private String bookListAPIUrl;

  
  public String getBookListAPIUrl() {
    return bookListAPIUrl;
  }

  
  public BookListByDate setBookListAPIUrl(String bookListAPIUrl) {
  ...
  public BookListByDate setMonth(String month) {
    this.month = month;
    return this;
  }
  /**
  ...
  public BookListByDate setYear(String year) {
    this.year = year;
    return this;
  }
   ...
   * example, a request that returns a single BookListByDate would include the response headers,
   * while a request which returns an array of BookListByDate, would have a non-null response header
