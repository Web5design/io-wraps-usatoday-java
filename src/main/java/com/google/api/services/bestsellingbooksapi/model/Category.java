...
/**
 * Model definition for Bestsellingbooksapi.Category.
 *
...
public final class Category extends GenericJson {
   ...
   * example, a request that returns a single Category would include the response headers, while a
   * request which returns an array of Category, would have a non-null response header in the
