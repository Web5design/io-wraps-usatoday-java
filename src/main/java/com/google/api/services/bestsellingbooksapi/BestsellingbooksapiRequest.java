...
/**
 * Generated Bestsellingbooksapi request.
 *
 * @since 1.3.0
 */
public class BestsellingbooksapiRequest extends JsonHttpRequest {

  /**
   * Builds an instance of BestsellingbooksapiRequest.
   *
   ...
   */
  public BestsellingbooksapiRequest(
