...
/**
 * Model definition for Bestsellingbooksapi.Format.
 *
 ...
 * @author Google, Inc.
 */
public final class Format extends GenericJson {
  ...
  public Format setPublisher(String publisher) {
  ...
  public Format setISBN(String iSBN) {
    this.iSBN = iSBN;
    return this;
  }
  /**
   ...
   * example, a request that returns a single Format would include the response headers, while a
   * request which returns an array of Format, would have a non-null response header in the
