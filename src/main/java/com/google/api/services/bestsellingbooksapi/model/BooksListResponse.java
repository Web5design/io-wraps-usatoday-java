...
/**
 * Model definition for Bestsellingbooksapi.BooksListResponse.
 *
 ...
 * @author Google, Inc.
 */
public final class BooksListResponse extends GenericJson {
  ...
  public BooksListResponse setAPIParameters(ApiParameters aPIParameters) {
   ...
   */
  @Key("BookLists")
  private java.util.List<BookList> bookLists;

  
  public java.util.List<BookList> getBookLists() {
    return bookLists;
  }

  
  public BooksListResponse setBookLists(java.util.List<BookList> bookLists) {
   ...
   * example, a request that returns a single BooksListResponse would include the response headers,
   * while a request which returns an array of BooksListResponse, would have a non-null response
