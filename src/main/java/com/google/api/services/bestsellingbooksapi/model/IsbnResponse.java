...
/**
 * Model definition for Bestsellingbooksapi.IsbnResponse.
 *
 ...
 * @author Google, Inc.
 */
public final class IsbnResponse extends GenericJson {
  ...
  public IsbnResponse setAPIParameters(ApiParameters aPIParameters) {
   ...
   */
  @Key("Title")
  private IsbnTitleEntry title;

  
  public IsbnTitleEntry getTitle() {
    return title;
  }

  
  public IsbnResponse setTitle(IsbnTitleEntry title) {
    this.title = title;
    return this;
  }
   ...
   * example, a request that returns a single IsbnResponse would include the response headers, while
   * a request which returns an array of IsbnResponse, would have a non-null response header in the
