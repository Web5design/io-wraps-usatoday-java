...
/**
 * Model definition for Bestsellingbooksapi.bookListsArray.
 *
 ...
 * @author Google, Inc.
 */
public final class bookListsArray extends GenericJson {

  @Key
  java.util.List<BookList> items;
   ...
   * example, a request that returns a single bookListsArray would include the response headers,
   * while a request which returns an array of bookListsArray, would have a non-null response header
