...
/**
 * Model definition for Bestsellingbooksapi.classesArray.
 *
 ...
 * @author Google, Inc.
 */
public final class classesArray extends GenericJson {
   ...
   * example, a request that returns a single classesArray would include the response headers, while
   * a request which returns an array of classesArray, would have a non-null response header in the
