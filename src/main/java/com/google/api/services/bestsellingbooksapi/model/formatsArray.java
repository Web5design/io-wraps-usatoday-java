...
/**
 * Model definition for Bestsellingbooksapi.formatsArray.
 *
 ...
 * @author Google, Inc.
 */
public final class formatsArray extends GenericJson {

  @Key
  java.util.List<Format> items;
   ...
   * example, a request that returns a single formatsArray would include the response headers, while
   * a request which returns an array of formatsArray, would have a non-null response header in the
