...
/**
 * Model definition for Bestsellingbooksapi.BooksByDateResponse.
 *
 ...
 * @author Google, Inc.
 */
public final class BooksByDateResponse extends GenericJson {
  ...
  public BooksByDateResponse setAPIParameters(ApiParameters aPIParameters) {
   ...
   */
  @Key("BookListDates")
  private java.util.List<BookListByDate> bookListDates;

  
  public java.util.List<BookListByDate> getBookListDates() {
    return bookListDates;
  }

  
  public BooksByDateResponse setBookListDates(java.util.List<BookListByDate> bookListDates) {
   ...
   * example, a request that returns a single BooksByDateResponse would include the response
   * headers, while a request which returns an array of BooksByDateResponse, would have a non-null
