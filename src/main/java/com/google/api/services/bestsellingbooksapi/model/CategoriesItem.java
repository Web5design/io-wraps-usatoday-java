...
/**
 * Model definition for Bestsellingbooksapi.CategoriesItem.
 *
 ...
 * @author Google, Inc.
 */
public final class CategoriesItem extends GenericJson {
  ...
  public CategoriesItem setCategoryID(Integer categoryID) {
  ...
  public CategoriesItem setCategoryName(String categoryName) {
   ...
   * example, a request that returns a single CategoriesItem would include the response headers,
   * while a request which returns an array of CategoriesItem, would have a non-null response header
