...
/**
 * Model definition for Bestsellingbooksapi.bookListEntriesArray.
 *
 ...
 * @author Google, Inc.
 */
public final class bookListEntriesArray extends GenericJson {

  @Key
  java.util.List<BookListEntry> items;
   ...
   * example, a request that returns a single bookListEntriesArray would include the response
   * headers, while a request which returns an array of bookListEntriesArray, would have a non-null
