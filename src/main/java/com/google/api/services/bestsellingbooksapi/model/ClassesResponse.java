...
/**
 * Model definition for Bestsellingbooksapi.ClassesResponse.
 *
 ...
 * @author Google, Inc.
 */
public final class ClassesResponse extends GenericJson {
  ...
  public ClassesResponse setAPIParameters(ApiParameters aPIParameters) {
  ...
  public ClassesResponse setClasses(java.util.List<String> classes) {
   ...
   * example, a request that returns a single ClassesResponse would include the response headers,
   * while a request which returns an array of ClassesResponse, would have a non-null response
