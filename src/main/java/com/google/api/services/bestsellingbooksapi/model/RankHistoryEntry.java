...
/**
 * Model definition for Bestsellingbooksapi.RankHistoryEntry.
 *
 ...
 * @author Google, Inc.
 */
public final class RankHistoryEntry extends GenericJson {
  ...
  public RankHistoryEntry setBookListDate(BookListByDate bookListDate) {
  ...
  public RankHistoryEntry setRank(Integer rank) {
    this.rank = rank;
    return this;
  }
   ...
   * example, a request that returns a single RankHistoryEntry would include the response headers,
   * while a request which returns an array of RankHistoryEntry, would have a non-null response
