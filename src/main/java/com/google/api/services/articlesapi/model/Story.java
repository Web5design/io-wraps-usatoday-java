...
/**
 * Model definition for Articlesapi.Story.
 *
 ...
 * @author Google, Inc.
 */
public final class Story extends GenericJson {
   ...
   * example, a request that returns a single Story would include the response headers, while a
   * request which returns an array of Story, would have a non-null response header in the enclosing
   * object only.
   */
